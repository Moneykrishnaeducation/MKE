...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-600 via-gray-700 to-gray-800 text-slate-800">
      <div className="max-w-screen-xl mx-auto px-4 py-8">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-2"><Mail className="w-4 h-4  text-teal-400" aria-hidden="true" /><a href="mailto:moneykrishnaeducation@gmail.com" className="hover:underline  rounded">moneykrishnaeducation@gmail.com</a></li>
              <li className="flex items-center gap-2"><Phone className="w-4 h-4  text-teal-400" aria-hidden="true" /><a href="tel:9500074778" className="hover:underline  rounded">+91 95000 74778</a></li>
              <li className="flex items-start gap-2"><MapPin className="w-4 h-4  text-teal-400 mt-1" aria-hidden="true" /><span>3rd floor, I Block, 35th Street, 18th Main Rd, Anna Nagar West, Chennai.</span></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-screen-xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between text-gray-400">
          ...
          <div className="mt-3 md:mt-0">
            <a href="#" className="text-teal-400 hover:underline  rounded">Terms &amp; Conditions</a>
            <span className="mx-2">·</span>
            <a href="#" className="text-teal-400 hover:underline  rounded">Privacy Policy</a>
          </div>
        </div>
      </div>
    </footer>
