    ...
    <footer className="w-full bg-gray-200 text-slate-800 z-10" role="contentinfo">
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-6">
          <div className="md:col-span-4">
            <div className="flex items-center gap-3 mb-4">
              <Link to="/" className="inline-flex items-center gap-3 rounded" aria-label="Money Krishna Education home">
                <img src={logo} alt="Money Krishna Education logo" className="h-10 w-auto rounded-full" />
              </Link>
            </div>
          ...
          <nav className="md:col-span-2" aria-label="Footer About">
            <h4 className="font-semibold mb-4 text-gray-700">About Us</h4>
            <ul className="space-y-3 text-gray-600">
              <li><Link to="/about" className="hover:underline rounded">About</Link></li>
              <li><a href="#" className="hover:underline rounded">Meet the Team</a></li>
              <li><a href="#" className="hover:underline rounded">Testimonials</a></li>
              <li><a href="#" className="hover:underline rounded">Contact</a></li>
            </ul>
          </nav>
          ...
          <div className="md:col-span-2">
            ...
            <address className="not-italic space-y-3 text-gray-600">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:9500074778" className="hover:underline rounded">+91 95000 74778</a>
              </div>
      ...
      <div className="border-t border-gray-400">
        <div className="max-w-screen-xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between text-gray-400">
          ...
          <div className="mt-3 md:mt-0">
            ...
            <Link to="/policies" className="text-gray-800 hover:underline rounded">Privacy Policy</Link>
          </div>
        </div>
      </div>

      {/* Back-to-top button removed — `GoUpButton` is rendered in `App.jsx` */}
    </footer>
  )
}
